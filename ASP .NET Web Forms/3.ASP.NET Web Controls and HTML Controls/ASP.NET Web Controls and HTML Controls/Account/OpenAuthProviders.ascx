<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="OpenAuthProviders.ascx.cs" Inherits="ASP.NET_Web_Controls_and_HTML_Controls.Account.OpenAuthProviders" %>
