namespace Methods
{
    ...
    public class Methods
    {
        public static double CalculateTriangleArea(double a, double b, double c)
        {
            if (a <= 0 || b <= 0 || c <= 0)
            {
                throw new ArgumentOutOfRangeException("The size of side ot triangle cannot be less than 0 cm.");
            }

            if (a + b < c || b + c < a || a + c < b)
            {
                throw new ArgumentException("The sum of two sides cannot be less than the size of the third side");
            }
        ...
        public static string NumberToDigit(int number)
        {
            switch (number)
            {
                ...
                case 8: return "eight";
                case 9: return "nine";
                default: throw new ArgumentException("The number is not in the are from 0 to 9!");
            }
        }
